...
import { useVentasDataFixed } from '@/hooks/useVentasDataFixed';
...
const VentasPageContainerFixed = () => {
  const [dialogOpen, setDialogOpen] = useState(false);
  const { ventas, loadData, exportToExcel } = useVentasDataFixed();
...
export default VentasPageContainerFixed;
