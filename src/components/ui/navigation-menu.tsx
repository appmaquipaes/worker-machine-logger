...
>(({ className, children, ...props }, ref) => (
  ...
  >
    {children}{" "}
    <ChevronDown
      className="relative top-[1px] ml-1 h-3 w-3 transition duration-200 group-data-[state=open]:rotate-180 text-slate-700"
      aria-hidden="true"
    />
  </NavigationMenuPrimitive.Trigger>
))
